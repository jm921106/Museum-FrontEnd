                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        cat.forEach(function (item) {
                            if (item.code == arr[1]) {
                                $('#sub-title').html(item.title.split(' ')[0]);

                                item.srcImg.forEach(function (imgUrl) {
                                    imageSlideAdd(imgUrl);
                                });

                                $('#pagination').removeClass('swiper-pagination');
                                $('#pagination').addClass('swiper-pagination');

                                // $('item-slideParent').append(
                                //     "<div id = 'item-slideParent'class='swiper-container slider m-b-20'><div id='item-slide' class='swiper-wrapper'>" +
                                //     "<div class='swiper-slide'><img src='img/product.jpg' alt=''></div></div>" +
                                //     "<div id='pagination' class='swiper-pagination'></div></div>"
                                // )
...
function patternAdd(like_btn_id, icon_id, like_status_id, user_id, date, img_url, delay) {
    $('#result_contents').append(
        ...
        "<button id='" + like_btn_id + "' class='btn-floating btn waves-effect waves-light cus-background-transparent z-index-front'>" +
        ...
        "<i id='" + icon_id + "'  class='fa ion-heart cus-color-transparent2'></i>" +
        "</button>" +
        "</div>" +
