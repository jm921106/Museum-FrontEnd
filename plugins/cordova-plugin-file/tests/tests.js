    ...
    describe('File API', function () {
        ...
        if (cordova.platformId == 'android') {
            describe('content: URLs', function() {
                // Warning: Default HelloWorld www directory structure is required for these tests (www/index-classic.html at least)
                ...
                it("file.spec.138 copyTo: content", function(done) {
                    testContentCopy('content://org.apache.cordova.file.testprovider/www/index-classic.html', done);
                });
                ...
                it("file.spec.140 delete: content should fail", function(done) {
                    resolveLocalFileSystemURL('content://org.apache.cordova.file.testprovider/www/index-classic.html', function(entry) {
            ...
            describe('asset: URLs', function() {
                ...
                it("file.spec.143 copyTo: asset -> temporary", function(done) {
                    ...
                    transfer = function () {
                        resolveLocalFileSystemURL('file:///android_asset/www/index-classic.html', function(entry) {
